...
-- Host
if host ~= nil then
    print("" .. " 󰇅  " .. bold() .. blue() .. "Host" .. reset() .. ": " .. string.rep(" ", 16 - 10) .. host.model)
end
...
if uptime ~= nil then
    ...
    print("" .. " 󰖉  " .. bold() .. blue() .. "Uptime" .. reset() .. ": " .. string.rep(" ", 16 - 12) .. output)
end
...
if packageManagers ~= nil then
    ...
    print("" .. " 󰏗  " .. bold() .. blue() .. "Packages" .. reset() .. ": " .. string.rep(" ", 16 - 14) .. output)
end
...
if resolution ~= nil then
    if resolution.refresh ~= nil then
        ...
        print("" .. " 󰍹  " .. bold() .. blue() .. "Resolution" .. reset() .. ": " .. resolution.width)
    end
end
...
-- WM
if wm ~= nil then
    print("" .. " 󱂬  " .. bold() .. blue() .. "WM" .. reset() .. ": " .. string.rep(" ", 16 - 8) .. wm)
end
